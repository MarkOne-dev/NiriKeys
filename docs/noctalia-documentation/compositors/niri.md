...
> **Note**
> Option 1 requires the `[niri/backdrop]` section to be enabled in your Noctalia configuration. See *Wallpaper and backdrop* for the relevant options.
